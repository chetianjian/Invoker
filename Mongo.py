...
class Mongo(object):
    ...
    def code2name(cls, code: str) -> str:
        ...
        return None if result.empty else result["name"][0]
    ...
    def code2block(cls, code: str) -> List[str]:
        ...
        return None if result.empty else list(set(result["blockname"]))
    ...
    def block2code(cls, name: str) -> List[str]:
        ...
        return None if result.empty else list(set(result["code"]))
